      ...
      child: CheckboxListTile(
        ...
        onChanged: (bool value) async {
          ...
          if (AppConstants.role) {
            CustomAlertDialog(title: "Внимание", message: "Чтобы оставить заявку войдите как заказчик!",);
          }
          else {
            Navigator.push(context, MaterialPageRoute(
                builder: (context) =>
                    ServiceFinish(
                      servicePK: int.parse(widget.services.fields.service),
                      subservicePK: widget.services.pk,))
            );
          }
        },
      ),
